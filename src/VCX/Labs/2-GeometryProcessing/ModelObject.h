...
namespace VCX::Labs::GeometryProcessing {
    ...
    public:
        ...
        glm::mat4 GetTransform() const {
            return glm::translate(glm::mat4(1.f), _translate) * _rotate
                * glm::scale(glm::mat4(1.f), _scale);
        }
        void Rotate(float const deg, glm::vec3 const & axis) {
            _rotate = glm::rotate(glm::mat4(1.f), glm::radians(deg), axis) * _rotate;
        }
        void RotateX(float const deg) {
            _rotate =
                glm::rotate(glm::mat4(1.f), glm::radians(deg), glm::vec3(1.f, 0.f, 0.f)) * _rotate;
        }
        void RotateY(float const deg) {
            _rotate =
                glm::rotate(glm::mat4(1.f), glm::radians(deg), glm::vec3(0.f, 1.f, 0.f)) * _rotate;
        }
        void RotateZ(float const deg) {
            _rotate =
                glm::rotate(glm::mat4(1.f), glm::radians(deg), glm::vec3(0.f, 0.f, 1.f)) * _rotate;
        }
